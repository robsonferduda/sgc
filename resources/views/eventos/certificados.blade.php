            ...
            <div class="row" style="min-height: 300px;">
                <div class="col-md-12">
                    ...
                    <p class="center">
                        ...
                        do <strong>{{ $evento->nm_evento_eve }}</strong>, 
                        @if($evento->dt_inicio_eve == $evento->dt_final_eve)
                            que ocorreu do dia {{ $evento->dt_inicio_eve }}.
                        @else
                            que ocorreu entre os dias {{ date('d/m/Y', strtotime($evento->dt_inicial_eve)) }} a {{ date('d/m/Y', strtotime($evento->dt_final_eve)) }}.
                        @endif 
