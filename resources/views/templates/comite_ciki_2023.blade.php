<html>
    ...
    <body>
        ...
        <div class="corpo">
            ...
            <p>
                It is hereby certified that <strong>{{ $certificado->participante->ds_nome_par }}</strong> participated as a member of Scientific Committee in the joint edition of the 18th International Conference on Knowledge Management (ICKM2023) 
