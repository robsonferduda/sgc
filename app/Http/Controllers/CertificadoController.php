...
class CertificadoController extends Controller
{
    ...
    {
        $certificados = Certificado::whereIn('id_modelo_certificado_moc', [24])->get();
                        ...
                        foreach($participante as $p){
                            ...
                            DB::transaction(function () use ($p, $request, $participante) {
                                ...
                                if(!$participante){
                                    ...
                                    if($request->id_modelo_certificado_moc == 23)
                                    {
    ...
    public function notificar($id)
    {
        ...
        if($certificado){
            ...
            Mail::send('email.notificacao_ciki_2023', $data, function($message) use ($to_name, $to_email, $hash, $evento, $tipo) {
